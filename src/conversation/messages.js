...
مثلاً: تخرج، عرسان، صالة، عيد ميلاد، إيجار
أو ابعت تاريخ زي *15/6* والوقت *10:00*

لو تبي تكلم موظف الاستوديو مباشرة اكتب: *موظف*
لو تبي مساعدة قول *مساعدة*`;

const SOFT_HELP_TEXT =
  "حاضر 😊 قولي شنو تبي بالضبط — " +
  "تخرج، زفاف، صالة، عيد ميلاد، إيجار، أو نحجز موعد — " +
  "ونمشي معاك خطوة بخطوة. لو تبي موظف اكتب *موظف*.";

const HUMAN_HANDOFF_TEXT =
  "تمام 👍 وقفت الرد الآلي.\n" +
  "موظف الاستوديو راح يكمّل معاك هنا مباشرة.\n\n" +
  "_لإعادة تشغيل البوت اكتب: تشغيل_";

const BOT_RESUMED_TEXT =
  "تم تشغيل المساعد الآلي من جديد ✅\nكيف نقدر نخدمك؟";
